...
public class CreateUserOption   {
  ...
  public CreateUserOption createdAt(DateTime createdAt) {
   ...
   * @return createdAt
  **/
  @ApiModelProperty(example = "null", value = "For explicitly setting the user creation timestamp. Useful when users are migrated from other systems. When omitted, the user's creation timestamp will be set to \"now\".")
