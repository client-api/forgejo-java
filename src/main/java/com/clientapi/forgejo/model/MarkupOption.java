...
public class MarkupOption   {
  ...
  **/
   ...
   * @return filePath
  **/
  @ApiModelProperty(example = "null", value = "File path for detecting extension in file mode  in: body")
   ...
   * @return mode
  **/
  @ApiModelProperty(example = "null", value = "Mode to render (comment, gfm, markdown, file)  in: body")
   ...
   * @return text
  **/
  @ApiModelProperty(example = "null", value = "Text markup to render  in: body")
