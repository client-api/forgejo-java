...
public class InternalTracker {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("allow_only_contributors_to_track_time");
    openapiFields.add("enable_issue_dependencies");
    openapiFields.add("enable_time_tracker");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InternalTracker.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InternalTracker is not found in the empty JSON string", InternalTracker.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InternalTracker.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InternalTracker` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
