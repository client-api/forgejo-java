 ...
 */
@ApiModel(description = "CommitStatusState holds the state of a CommitStatus It can be \"pending\", \"success\", \"error\", \"failure\", and \"warning\"")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2023-10-14T16:18:05.057+02:00")
public class CommitStatusState   {
  ...
  public String toString() {
    ...
    sb.append("class CommitStatusState {\n");
