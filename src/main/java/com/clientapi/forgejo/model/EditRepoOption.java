...
import com.clientapi.forgejo.model.ExternalTracker;
import com.clientapi.forgejo.model.ExternalWiki;
import com.clientapi.forgejo.model.InternalTracker;
...
public class EditRepoOption   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to allow mark pr as merged manually, or `false` to prevent it.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to allow merging pull requests with a merge commit, or `false` to prevent merging pull requests with merge commits.")
   ...
   * @return allowRebase
  **/
  @ApiModelProperty(example = "null", value = "either `true` to allow rebase-merging pull requests, or `false` to prevent rebase-merging.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to allow rebase with explicit merge commits (--no-ff), or `false` to prevent rebase with explicit merge commits.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to allow updating pull request branch by rebase, or `false` to prevent it.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to allow squash-merging pull requests, or `false` to prevent squash-merging.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to enable AutodetectManualMerge, or `false` to prevent it. Note: In some special cases, misjudgments can occur.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "set to `true` to allow edits from maintainers by default")
  ...
  **/
  @ApiModelProperty(example = "null", value = "set to a merge style to be used by this repository: \"merge\", \"rebase\", \"rebase-merge\", or \"squash\".")
  ...
  **/
   ...
   * @return hasActions
  **/
  @ApiModelProperty(example = "null", value = "either `true` to enable actions unit, or `false` to disable them.")
  ...
  **/
   ...
   * @return hasPackages
  **/
  @ApiModelProperty(example = "null", value = "either `true` to enable packages unit, or `false` to disable them.")
  ...
  **/
   ...
   * @return hasReleases
  **/
  @ApiModelProperty(example = "null", value = "either `true` to enable releases unit, or `false` to disable them.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "either `true` to ignore whitespace for conflicts, or `false` to not ignore whitespace.")
