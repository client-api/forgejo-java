...
public class NotificationSubject {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("latest_comment_html_url");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationSubject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotificationSubject is not found in the empty JSON string", NotificationSubject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationSubject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotificationSubject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("latest_comment_html_url") != null && !jsonObj.get("latest_comment_html_url").isJsonNull()) && !jsonObj.get("latest_comment_html_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `latest_comment_html_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("latest_comment_html_url").toString()));
      }
