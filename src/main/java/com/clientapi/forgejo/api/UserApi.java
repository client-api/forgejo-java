...
import com.clientapi.forgejo.model.InlineResponse2001;
...
public class UserApi {
    ...
    private com.squareup.okhttp.Call userBlockUserCall(String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/user/block/{username}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<Void> userBlockUserWithHttpInfo(String username) throws ApiException {
        com.squareup.okhttp.Call call = userBlockUserCall(username, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userBlockUserAsync(String username, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = userBlockUserCall(username, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for userCheckFollowing */
    private com.squareup.okhttp.Call userCheckFollowingCall(String username, String target, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/users/{username}/following/{target}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "username" + "\\}", apiClient.escapeString(username.toString()))
    ...
    public ApiResponse<Void> userCheckFollowingWithHttpInfo(String username, String target) throws ApiException {
        com.squareup.okhttp.Call call = userCheckFollowingCall(username, target, null, null);
        return apiClient.execute(call);
    }
    ...
    private com.squareup.okhttp.Call userCreateHookCall(CreateHookOption body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        ...
        // create path and map variables
        String localVarPath = "/user/hooks".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<Hook> userCreateHookWithHttpInfo(CreateHookOption body) throws ApiException {
        com.squareup.okhttp.Call call = userCreateHookCall(body, null, null);
    ...
    private com.squareup.okhttp.Call userCreateTokenCall(String username, CreateAccessTokenOption body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    public ApiResponse<AccessToken> userCreateTokenWithHttpInfo(String username, CreateAccessTokenOption body) throws ApiException {
        com.squareup.okhttp.Call call = userCreateTokenCall(username, body, null, null);
    ...
    private com.squareup.okhttp.Call userCurrentTrackedTimesCall(Integer page, Integer limit, DateTime since, DateTime before, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<TrackedTime> userCurrentTrackedTimes(Integer page, Integer limit, DateTime since, DateTime before) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<TrackedTime>> userCurrentTrackedTimesWithHttpInfo(Integer page, Integer limit, DateTime since, DateTime before) throws ApiException {
        com.squareup.okhttp.Call call = userCurrentTrackedTimesCall(page, limit, since, before, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userCurrentTrackedTimesAsync(Integer page, Integer limit, DateTime since, DateTime before, final ApiCallback<List<TrackedTime>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call userDeleteHookCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/user/hooks/{id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    public ApiResponse<Void> userDeleteHookWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = userDeleteHookCall(id, null, null);
        return apiClient.execute(call);
    }
    ...
    private com.squareup.okhttp.Call userEditHookCall(Long id, EditHookOption body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    public ApiResponse<Hook> userEditHookWithHttpInfo(Long id, EditHookOption body) throws ApiException {
        com.squareup.okhttp.Call call = userEditHookCall(id, body, null, null);
        Type localVarReturnType = new TypeToken<Hook>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call userGetHookCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<Hook> userGetHookWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = userGetHookCall(id, null, null);
        Type localVarReturnType = new TypeToken<Hook>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call userListActivityFeedsCall(String username, Boolean onlyPerformedBy, LocalDate date, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/users/{username}/activities/feeds".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "username" + "\\}", apiClient.escapeString(username.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        if (onlyPerformedBy != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "only-performed-by", onlyPerformedBy));
        if (date != null)
    ...
    public ApiResponse<List<Activity>> userListActivityFeedsWithHttpInfo(String username, Boolean onlyPerformedBy, LocalDate date, Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = userListActivityFeedsCall(username, onlyPerformedBy, date, page, limit, null, null);
    ...
    private com.squareup.okhttp.Call userListBlockedUsersCall(Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/user/list_blocked".replaceAll("\\{format\\}","json");
    ...
    public List<BlockedUser> userListBlockedUsers(Integer page, Integer limit) throws ApiException {
        ApiResponse<List<BlockedUser>> resp = userListBlockedUsersWithHttpInfo(page, limit);
        return resp.getData();
    }
    ...
    public ApiResponse<List<BlockedUser>> userListBlockedUsersWithHttpInfo(Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = userListBlockedUsersCall(page, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userListBlockedUsersAsync(Integer page, Integer limit, final ApiCallback<List<BlockedUser>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = userListBlockedUsersCall(page, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<BlockedUser>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call userListHooksCall(Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<List<Hook>> userListHooksWithHttpInfo(Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = userListHooksCall(page, limit, null, null);
    ...
    private com.squareup.okhttp.Call userUnblockUserCall(String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/user/unblock/{username}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "username" + "\\}", apiClient.escapeString(username.toString()));
    ...
    public ApiResponse<Void> userUnblockUserWithHttpInfo(String username) throws ApiException {
        com.squareup.okhttp.Call call = userUnblockUserCall(username, null, null);
        return apiClient.execute(call);
    }
